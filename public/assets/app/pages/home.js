...
$(function () {
  ...
  var widgetChart1 = new ApexCharts(
    document.querySelector("#widget-chart-1"),
    _objectSpread(
      ...
      {},
      {
        ...
        fill: { type: "solid" },
        markers: { strokeColors: isDarkDefault ? colors.black : colors.white },
        stroke: { show: false },
        tooltip: {
          marker: { show: false },
          y: {
  ...
  var widgetChart6 = new ApexCharts(
    document.querySelector("#widget-chart-6"),
    _objectSpread(
      _objectSpread({}, themeOptions[themeVariantDefault]),
      {},
      {
  ...
  var widgetChart7 = $(".widget-chart-7").map(function () {
    ...
    var enabledCurrency = $(this).data("chart-currency");
    return new ApexCharts(
      ...
      _objectSpread(
        ...
        {},
        {
          ...
          fill: { type: "solid", colors: [color], opacity: 0.1 },
          ...
          tooltip: {
            ...
            y: {
              formatter: function formatter(val) {
                return Boolean(enabledCurrency) ? currency.format(val) : val;
              },
            },
          },
          xaxis: {
  ...
  $("#theme-toggle").on("click", function () {
    ...
    widgetChart6.updateOptions(
      _objectSpread(
        ...
        {
          markers: { strokeColors: isDark ? colors.black : colors.white },
          fill: { gradient: { shade: themeVariant } },
        },
      ),
    );
    widgetChart7.each(function () {
